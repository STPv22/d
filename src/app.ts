...
class App {
    constructor() {
        ...
        //layers
        const layer2dFront = GUI.AdvancedDynamicTexture.CreateFullscreenUI("2dLayerFront");
        
        var fpsCounter =  new GUI.TextBlock("fpsCounter", `FPS: ${engine.getFps().toFixed(2)}`);
        fpsCounter.width = "150px";
        fpsCounter.height = "40px";
        ...
        layer2dFront.addControl(fpsCounter);    
